function UI()
    ...
    local data = {
        ...
        Utils = {
            ...
            RemoteSpy = {
            {name = "SimpleSpy lite", callback = function() loadstring(game:HttpGet("https://raw.githubusercontent.com/Pcgamert/Ziro-hub/refs/heads/Scripts/SimpleSy%20Lite2.lua"))() end},
            },
        },
        Misc = {
