function UI()
    ...
    local data = {
        ...
        Utils = {
            DarkDex = {
            {name = "DarkDexV1", callback = function() loadstring(game:HttpGet("https://github.com/Pcgamert/Ziro-hub/blob/Scripts/DarkDexv1.lua"))() end},
            ...
            RemoteSpy = {
            {name = "SimpleSpy lite", callback = function() loadstring(game:HttpGet("https://raw.githubusercontent.com/Pcgamert/Ziro-hub/Scripts/utils/RemoteSpy/SimpleSpy%20lite.lua"))() end},
            },
        },
        Misc = {
